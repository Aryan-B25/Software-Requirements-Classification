...
# === Save Results ===
with open(os.path.join(OUTPUT_PATH, "xlnet_classification_report.txt"), "w") as f:
    f.write(f"Accuracy: {acc:.4f}\n\n")
    f.write(report)

with open(os.path.join(OUTPUT_PATH, "xlnet_metrics_summary.json"), "w") as f:
...
plt.ylabel("True")
plt.savefig(os.path.join(OUTPUT_PATH, "xlnet_confusion_matrix.png"))
plt.close()

model.save_pretrained(OUTPUT_PATH)
tokenizer.save_pretrained(OUTPUT_PATH)

print("XLNet model and tokenizer saved to:", OUTPUT_PATH)