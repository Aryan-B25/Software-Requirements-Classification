...
# === Save Results ===
with open(os.path.join(OUTPUT_PATH, "deberta_classification_report.txt"), "w") as f:
    f.write(f"Accuracy: {acc:.4f}\n\n")
    f.write(report)

with open(os.path.join(OUTPUT_PATH, "deberta_metrics_summary.json"), "w") as f:
...
plt.ylabel("True")
plt.savefig(os.path.join(OUTPUT_PATH, "deberta_confusion_matrix.png"))
plt.close()

model.save_pretrained(OUTPUT_PATH)
tokenizer.save_pretrained(OUTPUT_PATH)

print("Training complete. Model and tokenizer saved to:", OUTPUT_PATH)